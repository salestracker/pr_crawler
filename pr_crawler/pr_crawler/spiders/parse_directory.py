...
_COMPANY_FIELDS_1 = {
    'name':
        '//table[2]//table//table[1]//tr[3]//h1/text()',
...
class ParseDirectorySpider(CrawlSpider):
  ...
  rules = (
      Rule(LinkExtractor(allow=_BIZ_LINKS, deny=_DENY_LINKS),
           callback=None,
           follow=True),
      Rule(LinkExtractor(allow=_COMPANY_LINK, deny=_DENY_LINKS + _BIZ_LINKS),
           callback='parse_item',
           follow=False),
  )
